...
internal sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        Icon = new Icon(Path.Combine(AppPaths.AssetsDirectory, "app-icon.ico"));
    ...
    private Control BuildHeader()
    {
        ...
        var logoPath = Path.Combine(AppPaths.AssetsDirectory, "inat-trailcam-logo.png");
    ...
    private Control BuildFooter()
    {
        ...
        var logoPath = Path.Combine(AppPaths.AssetsDirectory, "logo-polones-footer.png");
        var logo = new PictureBox
        {
            Image = Image.FromFile(logoPath),
            SizeMode = PictureBoxSizeMode.Zoom,
